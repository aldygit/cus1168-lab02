...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Tesla " + myTesla.getModel() + " " + myTesla.getYear());
        ...
        System.out.println("Autopilot is currently: " + (myTesla.isAutopilotEnabled() ? "enabled" : "disabled")); // Check autopilot status
        ...
        System.out.println("\nFinal car status:");
        myTesla.stopEngine();
        System.out.println("Tesla " + myTesla.getModel() + " stopped");
        System.out.println("Running: " + myTesla.isRunning());
        System.out.println("Autopilot: " + myTesla.isAutopilotEnabled());
        System.out.println("Charging: " + myTesla.isCharging());
    }
